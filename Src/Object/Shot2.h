...
public:
	...
	// 弾の生存時間
	static constexpr float SHOT_ALIVE = 0.1f;
	...
	// エフェクトの最大アニメーション
	static constexpr int EFFECT_MAX_NUM_ANIM = 54;

	// エフェクトのサイズ
	static constexpr int EFECT_SIZE_X = 355;
	static constexpr int EFECT_SIZE_Y = 365;

	// エフェクトの分割数
	static constexpr int EFFECT_NUM_X = 9;
	static constexpr int EFFECT_NUM_Y = 6;
